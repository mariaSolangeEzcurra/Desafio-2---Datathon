...
def procesar_archivo_excel(
    ...
    # 1. Cargar y validar estructura básica del Excel
    try:
    ...
    db.add(log_carga)
    db.flush()  # Genera el id_carga en la sesión actual
    id_carga_actual = log_carga.id_carga

    filas = df.to_dict("records")
    
    # 3. Precarga de memorias caché para optimizar consultas (evita problema N+1)
    zonas_keys = set()
    rutas_ids = set()
    ...
    # Consulta de duplicados en bloques de 1000
    ...
    try:
        ...
        # Insertar los registros pendientes del último lote
        ...
        # 5. Si todo falló, hacer rollback seguro sin perder el contexto de respuesta
        ...
        # Actualizar estado final del Log

...
export default function Dashboard({ idSeleccionado }) {
  ...
  const metrics = {
    cumplimiento: {
      ...
      formula: "(Lecturas realizadas / Lecturas programadas) × 100",
      datos: "total_lecturas_realizadas y total_lecturas_programadas",
    },
    productividad: {
      ...
      formula: "Lecturas realizadas / horas trabajadas",
      datos: "productividad_lectura",
    },
    impedimentos: {
      nombre: "Impedimentos",
      ...
      formula: "(Impedimentos / Lecturas realizadas) × 100",
      datos: "impedimentos_lectura",
    },
    observaciones: {
      nombre: "Observaciones",
      valor: `${resumen.observaciones_lectura ?? 0}%`,
      descripcion: "Porcentaje de lecturas que registraron observaciones.",
      formula: "(Observaciones / Lecturas realizadas) × 100",
      datos: "observaciones_lectura",
    },
    coberturaGps: {
      ...
      formula: "(Actividades georreferenciadas / Total actividades) × 100",
      datos: "cobertura_georreferenciada",
    },
    fueraDeRadio: {
      nombre: "Fuera de punto",
      valor: resumen.actividades_fuera_de_punto ?? 0,
      descripcion:
        "Cantidad de actividades realizadas fuera del radio geográfico permitido.",
      formula: "Conteo de actividades fuera del punto permitido",
      datos: "actividades_fuera_de_punto",
    },
  };
        ...
        <>
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
              {Object.entries(metrics).map(([key, kpi]) => (
                <Tooltip
                  key={key}
                  title={kpi.nombre}
              ...
              {dashboard.ranking_lectores?.length > 0 ? (
                    ...
                    <tr className="border-b border-slate-200">
                      ...
                      <th className="px-5 py-3 font-bold text-center whitespace-nowrap bg-slate-50">
                        <Tooltip
                          ...
                          width="w-80"
                        >
                          <span className="cursor-help">Eficiencia</span>
                        </Tooltip>
                      </th>
                      <th className="px-5 py-3 font-bold text-center whitespace-nowrap bg-slate-50">
                        <Tooltip
                          ...
                          width="w-80"
                        >
                          <span className="cursor-help">Min/Lectura</span>
                        </Tooltip>
                      </th>
                    </tr>
                  </thead>
                ...
                <div className="flex flex-col items-center justify-center py-16 text-slate-400 gap-2">
                  ...
                  <p className="text-xs font-medium text-slate-500">
                    No hay datos de lectores para el período seleccionado.
                  </p>
                </div>
              )}
            </div>

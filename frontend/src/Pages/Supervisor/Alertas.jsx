...
export default function Alertas() {
  ...
  // Nombre del supervisor que realizó la atención
  ...
  // ==========================================================
  // BUSCAR NOMBRE DEL SUPERVISOR POR ID
  // ==========================================================
  const buscarNombreSupervisor = async (supervisorId) => {
    ...
    try {
      ...
      console.error(
        "Error buscando nombre del supervisor:",
        error
      );
  ...
  const verDetalle = async (alertaId) => {
    try {
      ...
      const data =
        await obtenerDetalleAlerta(alertaId);
      ...
      // ------------------------------------------------------
      // BUSCAR NOMBRE DEL SUPERVISOR SI EXISTE
      // ------------------------------------------------------
      if (data?.supervisor_id) {
        const nombre =
          await buscarNombreSupervisor(
            data.supervisor_id
          );
  ...
  const actualizarEstado = async () => {
    ...
    try {
      ...
      // ------------------------------------------------------
      // 1. OBTENER USUARIO ACTIVO DEL LOCALSTORAGE
      // ------------------------------------------------------
      ...
      // ------------------------------------------------------
      // 2. OBTENER USUARIOS DESDE LA BASE DE DATOS
      // ------------------------------------------------------
      const usuarios =
      ...
      // ------------------------------------------------------
      // 4. OBTENER ID REAL DEL SUPERVISOR
      // ------------------------------------------------------
      const supervisorId =
        usuarioBD.id_usuario;

      console.log(
        "SUPERVISOR ID ENVIADO:",
        supervisorId
      );

      if (!supervisorId) {
        throw new Error(
          "El usuario encontrado no tiene id_usuario."
        );
      }

      // ------------------------------------------------------
      // 5. OBTENER NOMBRE DEL SUPERVISOR
      // ------------------------------------------------------
      const nombreSupervisor =
        obtenerNombreUsuario(usuarioBD);
      ...
      // ------------------------------------------------------
      // 7. ENVIAR ACTUALIZACIÓN AL BACKEND
      // ------------------------------------------------------
      ...
      // ------------------------------------------------------
      // 8. ACTUALIZAR DATOS VISUALES DEL DETALLE
      // ------------------------------------------------------
      setSupervisorNombre(
        nombreSupervisor
      );
      ...
      // ------------------------------------------------------
      setMensaje(
        `Alerta actualizada correctamente por ${nombreSupervisor || "el supervisor"}.`
      );

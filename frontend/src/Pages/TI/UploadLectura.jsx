...
export default function UploadLectura({ onSincronizacionExitosa }) {
  ...
  const handleUpload = async (e) => {
    ...
    setStatus({
      type: "info",
      message: "Procesando archivo y validando columnas en el servidor..."
    });
    ...
    try {
      ...
      let mensaje =
        "No se pudo procesar el archivo. Verifique la conexión o el formato de las columnas.";
    ...
    <div className="space-y-6 text-left">
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
            ...
            {archivo ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-600 font-medium">
                  ...
                  Haga clic aquí para seleccionar el archivo Excel (.xlsx, .xls)
        ...
        {status.message && (
          ...
          <div
            ...
            className={`mt-4 p-4 rounded-xl border text-xs flex items-start gap-3 shadow-sm ${
              ...
              <span className="font-bold block mb-0.5">
...

                {
                  status.type === "error"
                    ...
                    ? "Atención / Error en la validación:"
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
        ...
        <h3 className="text-sm font-bold text-slate-700 uppercase mb-4 flex items-center gap-2">
          ...
          Auditoría de Cargas: Lecturas Comerciales
              ...
              {historialFiltrado.length === 0 ? (
                ...
                historialFiltrado.map((h) => (
                  ...
                  >
                    ...
                    <td className="p-3 font-bold text-[#006cb7]">
